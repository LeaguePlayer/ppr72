...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <?if($model->img){?>    
        <div class="row">    
            <?echo CHtml::image(fnc::getThumb(Yii::app()->params['news'],$model->img,115,161));?>
    	</div>
    <?}?>
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'short_desc')  ?>
		<?php echo $form->error($model,'short_desc'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'full_desc'); ?>
		<?php $this->widget('application.extensions.tinymce_elfinder.tinymce.ETinyMce', array('name'=>'News[full_desc]','value'=>$model->full_desc,  'options' => array(   
            'theme' => 'advanced',
             'width'=>'90%',
                'height'=>'450px',
